...
var slider = new img_Slider(nsOptions);

/* Ninja Slider v2016.12.29 Copyright www.menucool.com */
function img_Slider(a) {
    "use strict";
    ...
    var Wb = function (a) {
        ...
        Hb = function () {
            G("zoom-in", "transform:scale(1)", "transform:scale(" + a.scale + ")", "li.ns-show .img", a.e + l + "ms 1 alternate none");
            U();
            q(" ul li .img {background-size:cover;}")
        },
        Fb = function () {
            var c = a.e * 100 / (a.e + l),
            ...
            i.a.insertRule(b, 0);
            q(" li.ns-show .img {__animation:zoom-in " + (a.e + l) + "ms 1 alternate both;}");
            U();
            q(" ul li .img {background-size:cover;}")
        },
        U = function () {
        ...
        fb = function () {
            ...
            q(" .fs-icon{cursor:pointer;position:absolute;z-index:14;}");
        ...
        Pb = function (b, n) {
            if (b.lL === undefined) {
                var p = screen.width,
                    l = db(b, "*");
                if (l[e]) {
                    for (var g = [], a, i, h, c = 0; c < l[e]; c++) K(l[c], "img") && g.push(l[c]);
                    if (g[e]) a = g[0];
                    else b.lL = 0;
                    if (g[e] > 1) {
                        for (var c = 1; c < g[e]; c++) {
